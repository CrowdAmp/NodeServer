...
app.post('/twiliowebhook/', function (req, res) {
    ...
    if(phoneNumberToInfluencerIdDict[req.body.To]) {
      ...
      userContactInfoDict[req.body.From] = [false, "+12152654321"]
      ...
      addItemToFirebaseDatabase(phoneNumberToInfluencerIdDict[req.body.To] + "/IndividualMessageData/" +  req.body.From, "sendMessagesFrom", "+12152654321")
